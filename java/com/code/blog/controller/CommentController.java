...
public class CommentController {
	...
	public ResponseEntity<CommentDto> updateComments(@PathVariable(value = "postId") long postId,
			@PathVariable(value = "commentId") long commentId, @RequestBody CommentDto commentRequest) {

		return new ResponseEntity<CommentDto>(commentService.updateComment(commentRequest, commentId,postId),
				HttpStatus.OK);
	}
